...
{
    public partial class Confirma_XBa : Form
    {
        public Confirma_XBa()
        {
            InitializeComponent();
        ...
        public void IngredienteAdiciona()
        {
            ...
            string vai = "update IngredienteGasto set nome = nome, preco = preco+1.50, quantidade = quantidade+2 where id = 3" +
                "update IngredienteGasto set nome = nome, preco = preco+2.00, quantidade = quantidade+3 where id = 7" +
                "update IngredienteGasto set nome = nome, preco = preco+1.50, quantidade = quantidade+1 where id = 4" +
                "update IngredienteGasto set nome = nome, preco = preco+3.00, quantidade = quantidade+1 where id = 2" +
                "update IngredienteGasto set nome = nome, preco = preco+1.50, quantidade = quantidade+1 where id = 8" +
                "update IngredienteGasto set nome = nome, preco = preco+1.50, quantidade = quantidade+1 where id = 5" +
                "update IngredienteGasto set nome = nome, preco = preco+2.00, quantidade = quantidade+3 where id = 1";
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            //Retirar do banco "ingredientes" os devidos ingredientes usados no lanche do cliente e guarda em banco
                ...
                "update ingredientes set quantidade = quantidade-3 where nome = 'bacon'" +
                ...
                cmd.Parameters.AddWithValue("@nome", "X-Bacon");
                ...
                cmd.Parameters.AddWithValue("@tempo", "35");
                Conexao.OC();
