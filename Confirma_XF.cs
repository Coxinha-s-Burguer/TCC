...
{
    public partial class Confirma_XF : Form
    {
        public Confirma_XF()
        {
            InitializeComponent();
        ...
        public void IngredienteAdiciona()
        {
            ...
            string vai = "update IngredienteGasto set nome = nome, quantidade = quantidade+2, preco = preco+1  where id = 3" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+1, preco = preco+3.00 where id = 2" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+1, preco = preco+2.00 where id = 10" +
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            {            
                ...
                "update ingredientes set quantidade = quantidade-1 where nome = 'frango'" +
                ...
                cmd.Parameters.AddWithValue("@nome", "X-Frango");
                ...
                cmd.Parameters.AddWithValue("@tempo", "40");
                Conexao.OC();
