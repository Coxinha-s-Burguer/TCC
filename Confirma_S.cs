...
{
    public partial class Confirma_S : Form
    {
        public Confirma_S()
        {
            InitializeComponent();
        ...
        public void IngredienteAdiciona()
        {
            ...
            string vai = "update IngredienteGasto set nome = nome, quantidade = quantidade+2, preco = preco+1  where id = 3" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+1, preco = preco+3 where id = 2" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+1, preco = preco+1.50 where id = 4" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+1, preco = preco+1.50 where id = 8" +
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                "update ingredientes set quantidade = quantidade-1 where nome = 'quiejo'" +
                ...
                //IngredienteAdiciona();
                SqlCommand  cmdingrediente = new SqlCommand(ven,con); 
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandText = "Pedir_Lanche_Pronto";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@nome", "Simples");
                cmd.Parameters.AddWithValue("@preço", preco + ",50");
        ...
        private void Confirma_S_Load(object sender, EventArgs e)
        {
