...
{
    public partial class Confirma_XBu : Form
    {
        public Confirma_XBu()
        {
            InitializeComponent();
        ...
        public void IngredienteAdiciona()
        {
            ...
            string vai = "update IngredienteGasto set nome = nome, quantidade = quantidade+2, preco = preco+1  where id = 3" +
                "update IngredienteGasto set nome = nome, quantidade = quantidade+2, preco = preco+3.00 where id = 2" +
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            {            
                ...
                "update ingredientes set quantidade = quantidade-2 where nome = 'hamburger'" +
                ...
                cmd.Parameters.AddWithValue("@nome", "X-Burguer");
                ...
                cmd.Parameters.AddWithValue("@tempo", "25");
                Conexao.OC();
